...
function ScreeningPage() {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      // Refresh the cache
      queryClient.invalidateQueries({ queryKey: ["screening", stageId] });
    },
  });
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-8 min-h-screen">
        ...
        <div className="space-y-4">
          <div>
            ...
            >
              ...
              <option value="maybe">Follow Up</option>
            </select>
          </div>
          ...
          <button
            onClick={() => mutation.mutate({ note, decision })}
      ...
      {/* DARK DATA CARD (Updated from white to dark) */}
      {data && (
